...
Quick analysis of twitter reactions to the right-wing terrorist shootings in Hanau, Germany on 19th february 2020. I played around with this data as an excercise to get into analysis of tweets with R for sociological research. Most of the code is copied & adapted from [this tutorial](https://juanitorduz.github.io/text-mining-networks-and-visualization-plebiscito-tweets/) by [Dr. Juan Camilo Orduz](https://juanitorduz.github.io/)
...
all_tweets <- jsonlite::stream_in(file("data/hashtag_hanau_2020-02-19_2020_02_29_dump.json"), verbose = FALSE)
```
